...
def writeSummary(df, outputDir):
    ...
    outputFileName = outputDir / "procvApril17.csv"
    try:
...
if __name__ == "__main__":
    ...
    filePath = Path(
        r"C:\Users\em316047\OneDrive - Dalhousie University\(Elec_Ocean Eng) Aaron MacNeill's files - Bedford Basin Planetary\Data\60 - April 17 2025 (Monthly)\PROCV"
    )
